class User < ActiveRecord::Base
  ...
  def create_default_lists
    ...
    tutorial.todo_items.find_or_create_by(content: "Clicking or tapping the list title brings up the list items.")
    tutorial.todo_items.find_or_create_by(content: "Clicking or tapping the list title again gives you more options.")
    tutorial.todo_items.find_or_create_by(content: "Clicking or tapping a checkmark next to an item makes it complete.")
